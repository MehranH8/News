...
const Fashiondetailside=(props)=>{
    return(
        <Link to="#">
        <div className="group flex flex-row md:flex-col xl:flex-row gap-x-4 md:mb-4 lg:mb-0 border-b-[1px] border-dashed border-[#ededed] pb-3 mt-5">
...
export default Fashiondetailside