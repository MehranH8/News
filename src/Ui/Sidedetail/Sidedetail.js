...
const Sidedetail = () => {
    ...
    const [Sidenewdata, setSidenewdata] = useState({
        data: [
    ...
    return (
        <div>
            {/*title */}
            <div className="relative bg-cover w-full bg-center min-h-[400px] md:min-h-[600px] h-full" style={{ backgroundImage: `url(https://demo.tagdiv.com/newspaper_pro/wp-content/uploads/2019/08/120-696x471.jpg)` }} >
                <div className="w-full h-full bg-[#000] bg-opacity-60 absolute top-0"></div>
                <div className="relative -top-[60%] mx-8 sm:mx-16 text-white flex justify-self-center text-center my-auto flex-col flex-wrap  ">
                    <div className="mt-[20%] md:mt-[30%]">
                        <span className="text-white">فضای داخلی</span>
                        <h4 className="text-[24px] sm:text-[30px] text-center font-bold mt-6 mb-8">یک پروژه آپارتمان بزرگ دیگر برای شرکت ریپل گسترده</h4>
                        <div>
                            <span className="text-white text-[16px] sm:text-[18px] border-l-[1px] border-white px-2 ml-2">علی رضایی</span>
                            <span className="text-white text-[16px] sm:text-[18px]">13/10/1403</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="mx-8 md:mx-16 lg:mx-24 xl:mx-32 mt-20">
                <div className="flex lg:flex-row flex-col  gap-16 ">
                    ...
                    <div className="mt-10 lg:w-[90%]">
                        ...
                        <div className="mb-8">
                            <div className="flex flex-col  sm:flex-row gap-2 justify-center mb-10">
                                <Link className="" to="#">
                                    <span className="mx-auto sm:mx-0 max-w-[200px] flex gap-x-3 justify-center sm:justify-start text-white bg-[#516eab] py-2 px-3 hover:bg-opacity-80 transition-opacity duration-200">
                                        <FaFacebookF className="my-auto " /> | فیسبوک
                                    </span>
                                </Link>
                                <Link className="" to="#">
                                    <span className="mx-auto sm:mx-0 max-w-[200px] flex gap-x-3 justify-center sm:justify-start text-white bg-[#26c5f6] py-2 px-3 hover:bg-opacity-80 transition-opacity duration-200">
                                        <FaXTwitter className="my-auto " /> | توییتر
                                    </span>
                                </Link>
                                <Link className="" to="#">
                                    <span className="mx-auto sm:mx-0 max-w-[200px] flex gap-x-3 justify-center sm:justify-start text-white bg-[#ca212a] py-2 px-3 hover:bg-opacity-80 transition-opacity duration-200">
                                        <FaPinterestP className="my-auto " /> | پینترست
                                    </span>
                                </Link>
                                <Link className="" to="#">
                                    <span className="mx-auto sm:mx-0 max-w-[200px] flex gap-x-3 justify-center sm:justify-start text-white bg-[#7bbf6a] py-2 px-3 hover:bg-opacity-80 transition-opacity duration-200">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 justify-center sm:justify-start  w-full border-y-[1px] border-[#ededed] mt-8 mb-14 py-6">
                            <Link className="" to="#">
                                <span className="flex gap-x-3 mx-auto justify-center sm:justify-start sm:mx-0 max-w-[200px] text-white bg-[#516eab] py-2 px-3 hover:bg-opacity-80 transition-opacity duration-200">
                                    <FaFacebookF className="my-auto " /> | فیسبوک
                                </span>
                            </Link>
                            <Link className="" to="#">
                                <span className="flex gap-x-3 mx-auto justify-center sm:justify-start sm:mx-0 max-w-[200px] text-white bg-[#26c5f6] py-2 px-3 hover:bg-opacity-80 transition-opacity duration-200">
                                    <FaXTwitter className="my-auto " /> | توییتر
                                </span>
                            </Link>
                            <Link className="" to="#">
                                <span className="flex gap-x-3 mx-auto justify-center sm:justify-start sm:mx-0 max-w-[200px] text-white bg-[#ca212a] py-2 px-3 hover:bg-opacity-80 transition-opacity duration-200">
                                    <FaPinterestP className="my-auto " /> | پینترست
                                </span>
                            </Link>
                            <Link className="" to="#">
                                <span className="flex gap-x-3 mx-auto justify-center sm:justify-start sm:mx-0 max-w-[200px] text-white bg-[#7bbf6a] py-2 px-3 hover:bg-opacity-80 transition-opacity duration-200">
                                    <FaTelegramPlane className="my-auto " /> | تلگرام
                                </span>
                            </Link>
                        </div>
                        ...
                        <div className="mt-16 ">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-4 xl:gap-x-8 ">
                    ...
                    {/*mainpart */}
                    {/*sidebar */}
                    <div className="lg:mx-auto mt-6 sm:mt-10 mb-8 sm:mb-20 lg:mb-36 sticky top-10  w-full lg:w-[40%] h-full">
                        ...
                        <div>
                            ...
                            <div className="max-w-[90%]">
                                {Sidenewdata.data.map((item) => (
                                    <Sidenews title={item[0]} date={item[1]} />
                                ))}
                            </div>
                        </div>
                    </div>
